  ...
  return (
    <div className="advisor-search page-enter">
      <Seo
        ...
        description="Search vetted fiduciary financial advisors by specialty, location, and fees. Compare up to three advisors side by side and request an introduction free."
        canonicalUrl="https://financialprofessional.com/advisors"
      />
