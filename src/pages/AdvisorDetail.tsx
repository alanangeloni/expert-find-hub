            ...
            <div className="flex-1 flex flex-col md:flex-row justify-between gap-6">
                  ...
                  <div className="flex">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star
                        key={star}
                        className={`h-4 w-4 ${
                          star <= Math.floor(Number(advisor.rating) || 0)
              ...
              {(advisor.position || advisor.firm_name) && (
                <p className="text-gray-700">
                  ...
                  {advisor.firm_name && (
                    <span className="text-gray-600"> at {advisor.firm_name}</span>
                  )}
                </p>
              )}
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2 md:pt-0 md:items-center">
                ...
                <Dialog open={isMeetingDialogOpen} onOpenChange={setIsMeetingDialogOpen}>
                  <DialogTrigger asChild>
                    <Button 
                      className="bg-[#1a365d] hover:bg-[#2c5282] text-white w-full sm:w-auto transition-colors duration-200"
                      size="lg"
                    >
            ...
            <div className="space-y-4">
              ...
              <Card className="p-6 text-center">
                ...
                <Dialog open={isMeetingDialogOpen} onOpenChange={setIsMeetingDialogOpen}>
                  <DialogTrigger asChild>
                    <Button 
                      className="w-full bg-[#1a365d] hover:bg-[#2c5282] transition-colors duration-200" 
                      size="lg"
                    >
                      <Calendar className="h-4 w-4 mr-2" />
                      Request Meeting
